  ...
  try {
    ...
    if ((existingChunks || []).length > 0) {
      ...
      return jsonResponse({
        ...
        settings: {
          mediumSilenceMs: body.mediumSilenceMs ?? 6000,
          longSilenceMs: body.longSilenceMs ?? 25000,
          minChunkMs: body.minChunkMs ?? 5000,
          analysisWindowMs: body.analysisWindowMs ?? 200,
