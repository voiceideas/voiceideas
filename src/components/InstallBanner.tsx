...
export function InstallBanner() {
  ...
  return (
    <div className="border-b border-primary/15 bg-primary/6 backdrop-blur">
      <div className="mx-auto flex max-w-2xl items-center gap-3 px-4 py-2 text-sm">
        ...
        <button
          ...
          className="inline-flex shrink-0 items-center gap-1 rounded-full bg-primary px-3 py-1.5 text-xs font-semibold text-white transition-colors hover:bg-primary-dark"
        >
      ...
      {showManualSteps && (
        <div className="border-t border-primary/10 bg-white/70">
          <p className="mx-auto max-w-2xl px-4 py-2 text-xs text-gray-600">
            {manualInstallMode === 'android' ? (
              <>
