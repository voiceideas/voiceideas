    ...
    <div className="space-y-2">
      ...
      <div className="flex gap-2 overflow-x-auto pb-1 -mx-1 px-1">
        ...
        <button
          ...
          aria-label={t('folders.generalAria')}
            ...
            {editingId === folder.id ? (
              <div className="flex items-center gap-1 px-2 py-1">
                <input
                  ...
                  aria-label={t('folders.renameInputAria', { name: folder.name })}
                  ...
                  autoFocus
                />
                <button type="button" onClick={saveRename} className="p-0.5 hover:bg-green-100 rounded" aria-label={t('folders.renameSaveAria', { name: folder.name })}>
                  <Check className="w-3 h-3 text-green-600" />
                </button>
                <button type="button" onClick={() => setEditingId(null)} className="p-0.5 hover:bg-red-100 rounded" aria-label={t('folders.renameCancelAria')}>
              ...
              <>
                <button
                  ...
                  aria-label={t('folders.openAria', { name: folder.name, count: folder.note_count || 0 })}
                  ...
                  {confirmDeleteId === folder.id ? (
                    <>
                      <button
                        ...
                        aria-label={t('folders.confirmDeleteAria', { name: folder.name })}
                      >
                      ...
                      <button
                        ...
                        aria-label={t('folders.cancelDeleteAria')}
                      >
                        <X className="w-3 h-3" />
                      </button>
                    </>
